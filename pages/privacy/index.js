    ...
    return (
			<>
				<div className="container" style={{ textAlign: "justify" }}>
					...
					<b>Miguel Angel Lupani</b> usa y protege la información que es
					...
					web emplea la información con el fin de proporcionar el mejor servicio
					posible, particularmente para mantener un registro de usuarios, de
					...
					en cualquier momento. Miguel Angel Lupani está altamente comprometido
					para cumplir con el compromiso de mantener su información segura.
					Usamos los sistemas más avanzados y los actualizamos constantemente
					para asegurarnos que no exista ningún acceso no autorizado. Cookies
					...
					con un orden judicial. Miguel Angel Lupani Se reserva el derecho de
